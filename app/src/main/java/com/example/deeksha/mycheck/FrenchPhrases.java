...
public class FrenchPhrases extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String total= basic_beg+Constants.Translations.PHRASES.phrases[0]+basic_end;
        editText1.setText(total, TextView.BufferType.EDITABLE);
        imageView1.setImageResource(Constants.Basic_pics.basic_pics[4]);
    ...
    public void next(View v){
        ...
        try {
            if(i==9)
                ...
                Intent i = new Intent(FrenchPhrases.this, FrenchOptions.class);
                startActivity(i);
            }
            String total = basic_beg + Constants.Translations.PHRASES.phrases[i] + basic_end;
            Log.i("TAG", total);
            editText1.setText(total, TextView.BufferType.EDITABLE);
            imageView1.setImageResource(Constants.Basic_pics.basic_pics[4]);
            ...
            public void run() {
                handler.post(new Runnable() {
                    public void run() {
                        ...
                        editText2.setText(Constants.Template.PHRASES.phrases[index][i]);
