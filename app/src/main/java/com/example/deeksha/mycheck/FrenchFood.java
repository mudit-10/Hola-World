...
public class FrenchFood extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String total= basic_beg+Constants.Translations.FOOD.food[0]+basic_end;
        editText1.setText(total, TextView.BufferType.EDITABLE);
        imageView1.setImageResource(Constants.Food_pics.food_pics[0]);
    ...
    public void next(View v){
        ...
        try {
            if(i==8)
                ...
                Intent i = new Intent(FrenchFood.this, FrenchOptions.class);
                startActivity(i);
            }
            String total = basic_beg + Constants.Translations.FOOD.food[i] + basic_end;
            Log.i("TAG", total);
            editText1.setText(total, TextView.BufferType.EDITABLE);
            imageView1.setImageResource(Constants.Food_pics.food_pics[i]);
            ...
            public void run() {
                handler.post(new Runnable() {
                    public void run() {
                        ...
                        editText2.setText(Constants.Template.FOOD.food[index][i]);
